...
REACT_BUILD = os.path.join(os.path.dirname(__file__), 'Nexabot', 'frontend', 'build')
...
# Serve React's static assets under /react/static/ (matches homepage: "/react")
...
# Serve other React public assets (manifest, favicon, etc.)
@app.route('/react/<path:filename>')
def react_public(filename):
